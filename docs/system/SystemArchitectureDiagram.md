...
## Purpose
This diagram summarizes the runtime structure of the backend:

- Entry points are infrastructure only.
- The DI container wires adapters and orchestrators once per process.
- Orchestrators own business flow ordering and call ports implemented by adapters.
